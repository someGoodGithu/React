...
class ViewController: UIViewController, URLSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        animationView.frame = CGRect(x: 30 , y: view.bounds.height / 2 - 150, width: 300, height: 300 )
    ...
    func MainView() {
        ...
        let homeViewController = UIHostingController(rootView: ReactionGame.MainView())
    ...
    func sendToRequest() {
        let url = URL(string: "https://ReactionBallGame.homes/starting")
